...
| :--- | :--- | :--- | :--- |
| `version` | string | `0.2.0` | Pinned `citeguard` version installed via `pipx`. Set to `latest` to track HEAD. |
...
* `@v0.2.0` — pinned major+minor+patch. Recommended for production.
