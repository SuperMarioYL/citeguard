...
| :--- | :--- | :--- | :--- |
| `version` | string | `0.8.0` | Pinned `citeguard` version installed via `pipx`. Set to `latest` to track HEAD. |
...
* `@v0.8.0` — pinned major+minor+patch. Recommended for production.
